...
namespace ZStudio.D365.DeploymentHelper.Core.CmdLineTools
{
    ...
    public class SetSLAStatus : HelperToolBase
    {
        ...
        public SetSLAStatus(string crmConnectionString, string configJson, Dictionary<string, string> tokens, bool portalEnhancedMode, bool debugMode, int debugSleep) : base(crmConnectionString, configJson, tokens, portalEnhancedMode, debugMode, debugSleep)
        {
        }
