...
REM additional DLL for WebAPI
set WebApiInputFiles=System.Net.Http.Formatting.dll Newtonsoft.Json.dll

set InputFiles=%TargetFileName% D365DT.Test.Demo.XrmEntity.dll %WebApiInputFiles%
