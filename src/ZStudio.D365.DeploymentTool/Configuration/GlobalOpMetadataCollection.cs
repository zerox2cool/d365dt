...
{
    /// <summary>
    /// The collection class that will store the list of Global OptionSet Definitions to be created/updated.
    /// </summary>
    [ConfigurationCollection(typeof(MetadataElement))]
    public class GlobalOpMetadataCollection : ConfigurationElementCollection
    {
        public GlobalOpMetadataCollection() : base() { }

        public GlobalOpMetadataCollection(string xmlFilePath)
        {
